...
const projects: Project[] = [
  ...
  },
  {
    ...
    tags: ["브랜딩"],
    title: "ROI Digital",
    description: "데이터 기반 마케팅 에이전시를 위한 다이내믹 랜딩. 애니메이션을 활용해 메시지 전달력을 높였습니다.",
    categories: ["brand"],
    desktopImage: "/images/portfolio/maranatha-desktop.png",
    mobileImage: "/images/portfolio/maranatha-mobile.png",
  },
];
